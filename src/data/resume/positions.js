const positions = [
  {
    ...
    position: 'Machine Learning Algorithm Engineer - Perception',
  ...
  {
    company: 'Lucid Motors',
    position: 'Staff Software Engineer - iOS',
    link: 'https://www.lucidmotors.com/',
    ...
    points: [
      ...
      'Developed a SwiftUI component toolkit and frameworks for testing, localization, persistence, and networking, while authoring an architecture usage guide to enhance productivity and streamline onboarding.',
      ...
      'Built a WebRTC client to stream live video from the car\'s external cameras to a phone for security monitoring.',
    ],
  },
  {
